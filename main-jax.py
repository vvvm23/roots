...
COLOR_MODE_CHOICES = ["grayscale", "t_fixed_hue"]
...
def main(
    ...
    frame_roots_real = (frame_roots_real * (args.hist_bins - 1)).astype(np.int32)
    frame_roots_imag = (frame_roots_imag * (args.hist_bins - 1)).astype(np.int32)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--color-mode", type=str, default="t_fixed_hue", choices=COLOR_MODE_CHOICES)
